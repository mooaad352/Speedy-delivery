...
st.set_page_config(page_title="מערכת ניהול משלוחים מתקדמת", page_icon="🚚")

# --- הוספת עיצוב ורקע למסך (במקום לבן חלק) ---
st.markdown(
    """
    <style>
    /* שינוי הרקע הכללי של האפליקציה למראה מודרני ונעים */
    .stApp {
        background-color: #1e1e2f;
        color: #ffffff;
    }
    /* התאמת צבע הכותרות והטקסטים שיהיו בולטים על רקע כהה */
    h1, h2, h3, h4, h5, h6, p, label {
        color: #ffffff !important;
    }
    /* עיצוב קונטיינרים או כרטיסים למראה נקי */
    div.stContainer {
