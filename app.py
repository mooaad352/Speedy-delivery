...
def generate_html_contract_form():
    """
    יוצר קובץ HTML מעוצב לטופס ההתרשמות והחוזה של השליח/המשתמש כולל הגנות משפטיות מלאות וסעיף תשלומים
    """
...
<div class="container">
    ...
    <div class="contract-box">
        ...
        2. <strong>העדר יחסי עובד-מעביד:</strong> מוסכם בזאת במפורש כי בין מפעיל המערכת לבין השליח ו/או הלקוח לא מתקיימים ולא יתקיימו כל יחסי עובד-מעביד מכל מין וסוג שהוא. השליח פועל كקבלן עצמאי לחלוטין.<br><br>
        ...
        4. <strong>פטור מלא מאחריות למפעיל המערכת:</strong> מפעיל המערכת לא יישא בשום אחריות ישירה או עקיפה לכל נזק גוף, נזק רכוש, תאונת דרכים, איחור במסירה, קנסות, תביעות צד ג' או הוצאות מכל סוג שנגрמו עקב או בקשר עם ביצוע המשלוחים בפועל.<br><br>
        5. <strong>תשלומים והתחייבות פיננסית:</strong> השליח ו/או מנהל חברת המשלוחים מתחייבים להסדיר ולשלם את מלוא התשלומים, העמלות וההתחייבויות המגיעות למפעיל המערכת בתחילת כל חודש קלנדרי (החל מהיום הראשון ועד ה-5 לכל חודש). אי הסדרת התשלום במוعدו תהווה הפרה יסודית של תנאי השימוש.<br><br>
        6. <strong>זכות תביעה ומיצוי הליכים בגין אי-תשלום:</strong> מוסכם בזאת באופן מפורש כי מפעיל המערכת יהיה רשאי לנקוט בכל הליך משפטי, לרבות הגשת תביעה משפטית ישירה נגד השליח ו/או מנהל חברת המשלוחים בגין אי הסדרת התשלום או איחור בתשלום החודשי, וכן לדרוש פיצויים, הוצאות משפט ושכר טרחת עורך דין בגין גביית החוב.<br><br>
...
if not st.session_state.logged_in:
    ...
    <div style="background-color: #1e293b; color: #f8fafc; border: 1px solid #475569; padding: 20px; border-radius: 8px; max-height: 250px; overflow-y: scroll; margin-bottom: 20px; line-height: 1.6; font-size: 14px;">
        ...
        6. <strong>זכות תביעה בגין אי-תשלום:</strong> מפעיל המערכת רשאי לנקוט בהליכים משפטיים ולהגיש תביעה ישירה נגד השליח או מנהל חברת המשלוחים בגין כל אי הסדרה של התשלום החודשי במועדו, כולל דרישה להוצאות משפט.<br><br>
